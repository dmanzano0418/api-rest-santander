 ...
 *
 */
public class TelefonosRequestDTO implements Serializable {

	private static final long serialVersionUID = 3520802322430032997L;
	
	public TelefonosRequestDTO() {};
	
	public TelefonosRequestDTO(Long id_telefonos,
